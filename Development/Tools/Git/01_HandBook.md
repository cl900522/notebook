...
# 常用命令
![](/images/2017/09/git-cheat-sheet.png)

![](/images/2017/09/git常用命令.png)
...
![](/images/2017/09/2016-07-14 21-26-37.jpg?r=49) ![](/images/2017/09/2016-07-14 21-15-47.jpg?r=49&f=2)
**匿名分支**：如果既没有指定文件名，也没有指定分支名，而是一个标签、远程分支、SHA-1值或者是像 master~3 类似的东西，就得到一个匿名分支，称作 detached HEAD（被分离的 HEAD 标识）。

![](/images/2017/09/2016-07-14 21-44-06.jpg?r=56)
...
![](/images/2017/09/2016-07-14 21-45-50.jpg?r=56)
...
- 修改整个历史记录中的某些错误的 author、email: `git rebase 或者 git filter-branch`
    ...
    ![](/images/2017/09/2017-06-02-11-51-27.jpg?r=54)
...
![](/images/2017/09/2016-07-14 20-31-39.png?r=64&f=1)
将工作区内容回退到远端的某个版本：`git reset --hard <sha1-of-commit>`
...
## Merge
![](/images/2017/09/2016-07-14 20-53-25.jpg?r=80)
...
![](/images/2017/09/2016-07-19 20-35-30.jpg?r=56)
...
![](/images/2017/09/2016-07-14 20-57-04.jpg?r=65)
...
![](/images/2017/09/2016-07-19 19-58-15.jpg?r=60)
...
- 基于之前的某个 Commit 新开分支： `git branch branchname <sha1-of-commit>`
	...
	+ 例: 创建一个空的分支
        ``` bash
        git checkout --orphan gh-pages # 创建一个orphan的分支，这个分支是独立的        Switched to a new branch 'gh-pages'
