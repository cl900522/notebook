...
![Git Workflows](/images/2017/09/git_workflow.png)

## 2.1 集中式工作流

如果你的开发团队成员已经很熟悉`Subversion`，集中式工作流让你无需去适应一个全新流程就可以体验`Git`带来的收益。这个工作流也可以作为向更`Git`风格工作流迁移的友好过渡。
![Git Workflows: SVN-style](/images/2017/09/git-workflow-svn.png)
...
![git-workflow-svn-push-local](/images/2017/09/git-workflow-svn-push-local.png)

### 2.1.2 冲突解决

中央仓库代表了正式项目，所以提交历史应该被尊重且是稳定不变的。如果开发者本地的提交历史和中央仓库有分歧，`Git`会拒绝`push`提交否则会覆盖已经在中央库的正式提交。

![git-workflow-svn-managingconflicts](/images/2017/09/git-workflow-svn-managingconflicts.png)
...
![](/images/2017/09/git-workflow-svn-initialize.png)
...
![](/images/2017/09/git-workflow-svn-clone.png)
...
![](/images/2017/09/git-workflow-svn-1.png)
...
![](/images/2017/09/git-workflow-svn-2.png)
...
![](/images/2017/09/git-workflow-svn-3.png)
...
![](/images/2017/09/git-workflow-svn-4.png)
...
![](/images/2017/09/git-workflow-svn-5.png)
...
![](/images/2017/09/git-workflow-svn-6.png)
...
![](/images/2017/09/git-workflow-svn-7.png)
...
![](/images/2017/09/git-workflow-svn-8.png)
...
![](/images/2017/09/git-workflow-svn-9.png)
...
![Git Workflows: Feature Branch](/images/2017/09/git-workflow-feature_branch.png)

![](/images/2017/09/git-workflow-feature-branch-1.png)
...
![](/images/2017/09/git-workflow-feature-branch-2.png)
...
![](/images/2017/09/git-workflow-feature-branch-3.png)
...
![](/images/2017/09/git-workflow-feature-branch-4.png)
...
![](/images/2017/09/git-workflow-feature-branch-5.png)

小黑收到了`Pull Request`后会查看`marys-feature`的修改。决定在合并到正式项目前是否要做些修改，且通过`Pull Request`和小红来回地讨论。

#### 小红再做修改

![](/images/2017/09/git-workflow-feature-branch-6.png)
...
![](/images/2017/09/git-workflow-feature-branch-7.png)
...
![Git Workflows: Gitflow Cycle](/images/2017/09/git-workflows-gitflow.png)
...
![](/images/2017/09/git-workflow-release-cycle-1historical.png)
...
![](/images/2017/09/git-workflow-release-cycle-2feature.png)

注意，从各种含义和目的上来看，功能分支加上`develop`分支就是功能分支工作流的用法。但`Gitflow`工作流没有在这里止步。

### 2.3.4 发布分支

![](/images/2017/09/git-workflow-release-cycle-3release.png)
...
![](/images/2017/09/git-workflow-release-cycle-4maintenance.png)
...
![](/images/2017/09/git-workflow-release-cycle-5createdev.png)
...
![](/images/2017/09/git-workflow-release-cycle-6maryjohnbeginnew.png)
...
![](/images/2017/09/git-workflow-release-cycle-7maryfinishes.png)
...
![](/images/2017/09/git-workflow-release-cycle-8maryprepsrelease.png)
...
![](/images/2017/09/git-workflow-release-cycle-9maryfinishes.png)
...
![](/images/2017/09/git-workflow-gitflow-enduserbug.png)
...
![](/images/2017/09/git-workflows-forking.png)
...
![](/images/2017/09/git-workflows-forking-1.png)
...
![](/images/2017/09/git-workflows-forking-2.png)
...
![](/images/2017/09/git-workflows-forking-3.png)
...
![](/images/2017/09/git-workflows-forking-4.png)
...
![](/images/2017/09/git-workflows-forking-5.png)
...
![](/images/2017/09/git-workflows-forking-6.png)
...
![](/images/2017/09/git-workflows-forking-7.png)
...
![](/images/2017/09/pull-request-bitbucket.png)
...
![](/images/2017/09/pull-request-overview.png)
...
![](/images/2017/09/pull-request-anatomy.png)
...
![](/images/2017/09/pull-request-feature-branch.png)
...
![](/images/2017/09/gitflow-workflow-pull-request.png)
...
![](/images/2017/09/pull-request-forking-workflow-1.png)
...
![](/images/2017/09/pull-request-forking-workflow-2.png)
...
![](/images/2017/09/pull-request-1.png)

小红先要`fork`小明的`Bitbucket`仓库，开始项目的开发。她登陆`Bitbucket`，浏览到小明的仓库页面，
点`Fork`按钮。

![](/images/2017/09/pull-request-2.png)

然后为`fork`出来的仓库填写名字和描述，这样小红就有了服务端的项目拷贝了。

#### 小红克隆她的`Bitbucket`仓库

![](/images/2017/09/pull-request-3.png)
...
![](/images/2017/09/pull-request-4.png)
...
![](/images/2017/09/pull-request-5.png)
...
![](/images/2017/09/pull-request-9.png)
...
![图片](/images/2017/09/branch_module.png)
...
![](/images/2017/09/2016-09-22-20-57-27.jpg)
...
![](/images/2017/09/2016-07-19 19-58-15.jpg)
